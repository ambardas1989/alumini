    ...
    <AuthLayout tagline={t('tagline')} subTagline={t('subTagline')}>
      ...
      {!showRedirectNotice && (
        <div className={styles.codeSection}>
          {/* No resend option — TOTP codes are generated by the
              authenticator app itself, not sent by this app, so there's
              nothing to resend. This helper text is the only thing shown
              in its place, for both modes (setup's own
              confirmSetupInstruction above already covers the same
              ground for that mode, but this is worded to match exactly
              across both). */}
